      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md flex flex-col h-full">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="space-y-3">
            <div className="bg-gray-50 dark:bg-gray-700 px-3 py-1.5 rounded-t-lg">
            ...
            {editingPassword ? (
              <div className="px-3 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg space-y-3">
                ...
                <div className="flex items-center gap-2 ml-7">
                  <button onClick={() => handleSave('password')} className="px-3 py-1.5 bg-gray-700 dark:bg-gray-600 hover:bg-gray-800 dark:hover:bg-gray-500 text-white rounded text-sm font-medium transition-colors inline-flex items-center gap-1">
                    <Save className="w-3.5 h-3.5" />
                    保存
                  </button>
                  <button onClick={() => { setEditingPassword(false); setFormData(prev => ({ ...prev, password: '', confirmPassword: '' })); }} className="px-3 py-1.5 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-600 rounded text-sm transition-colors">
                    取消
                  </button>
                </div>
              </div>
        ...
        <div className="p-6 border-t border-gray-200 dark:border-gray-700">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-4 py-2 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg text-sm font-medium transition-colors"
          >
