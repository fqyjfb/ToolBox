      ...
      <div className="border-t border-gray-200 dark:border-gray-700">
        ...
        <div className="p-4">
          <div className="grid grid-cols-5 gap-3 mb-4">
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3">
              <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">通用图标缓存</div>
              <div className="text-lg font-bold text-gray-900 dark:text-white">
                {isRefreshingIconCache ? (
                  <Loader2 className="w-4 h-4 inline animate-spin" />
                ) : (
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3">
              <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">插件图标缓存</div>
              <div className="text-lg font-bold text-gray-900 dark:text-white">
                {isRefreshingIconCache ? (
                  <Loader2 className="w-4 h-4 inline animate-spin" />
                ) : (
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3">
              <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">应用图标缓存</div>
              <div className="text-lg font-bold text-gray-900 dark:text-white">
                {isRefreshingIconCache ? (
                  <Loader2 className="w-4 h-4 inline animate-spin" />
                ) : (
